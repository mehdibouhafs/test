        ...
        $.ajax({
            ...
            success: function (data) {// le cas ou la requete est bien execute en reçoi les données serialiser par JSON dans la variable msg
                ...
                contenu +='<div class="row"><div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"> <div class="panel panel-primary"> <div class="panel-heading text-center"> Configuration des données </div> <div class="panel-body">'+
                    '<table class="table table-bordered table-hover" id="table_auto"> <thead> <tr> <th width="2%">Clé primaire</th> <th width="15%">colonne</th> <th width="15%">Type</th> <th width="10%">Taille</th> <th width="2%"> Non null</th> <th width="20%">Default</th> <th width="36%">Commentaire</th> </tr> </thead><tbody>';
                ...
                if(data.reader.executed == true) {
                    contenu+='</tbody></table> </div> </div> </div></div><div class="row"> <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"><div class="panel panel-primary"> <div class="panel-heading text-center"> Rapport du Batch </div> <div class="panel-body">'+
                        '<table class="table table-bordered table-hover" id="table_auto"><thead> <tr> <th width="2%">Batch Id</th> <th width="4%">Type de Batch</th> <th width="10%">Débute à</th> <th width="10%">Termine à </th> <th width="10%">Statut</th> <th width="10%">Read count</th> <th width="10%">Filter count</th> <th width="10%">Write count</th> <th width="10%">Read skip count</th> <th width="10%">Write skip count</th> <th width="10%">Process skip count</th> <th width="4%">Rollback count</th> </tr> </thead>'+
                    ...
                    if (data.inputError.length > 0) {
                        contenu += '<div class="row"> <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"><div class="panel panel-danger"> <div class="panel-heading text-center"> Erreur : </div> <div class="panel-body"> <table class="table table-bordered table-hover" id="table_auto"> <thead> <tr> <th width="5%">Numero de ligne</th> <th width="35%">Ligne</th> <th width="60%">Erreur dans</th><th> Cause</th> </tr> </thead><tbody>';
        ...
        $.ajax({
            ...
            success: function (data) {// le cas ou la requete est bien execute en reçoi les données serialiser par JSON dans la variable msg
                ...
                var contenu = "<div class='panel panel-success'><div class='panel-heading text-center'><div class='pad margin no-print'>"
                    ...
                    "<thead><tr><th><b>Path File</b></th><th ><b>Separator</b></th><th><b>Nb ligne sauter </b></th></thead><tbody>"+
